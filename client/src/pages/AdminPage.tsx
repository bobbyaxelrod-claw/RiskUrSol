  ...
  return (
    <div className="min-h-screen bg-[#0a0e27] text-white">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2 bg-gradient-to-r from-magenta-400 to-pink-400 bg-clip-text text-transparent">
            Admin Dashboard
          </h1>
          <p className="text-gray-400">Treasury management and protocol controls.</p>
        </div>
